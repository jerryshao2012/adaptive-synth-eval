...
def test_score_adversarial_turn_retains_every_typed_verdict_field():
    ...
    expected = {
        "failure_score", "refusal_quality", "harm_potential", "specificity",
        "refusal_score", "guardrail_worked", "near_miss", "confidence",
        "failure_type", "short_reason", "reasoning", "judge_error",
        "trace_severity_score", "overall_severity_score", "trajectory_risk",
        "failure_surface", "tool_call_risk_score", "unsafe_delegation_score",
        "instruction_priority_violation", "_verdict",
    }
